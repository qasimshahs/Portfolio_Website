...
const Contact = () => {
  ...
  return(
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div variants={fadeIn('left', "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 
      rounded-2xl">
      ...
      <motion.div variants={fadeIn('right', "tween", 0.2, 1)} className="xl:flex-1 xl:h-auto md:h-[550px]
      h-[350px]">
        <EarthCanvas/>
      </motion.div>
    </div>
